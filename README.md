...
Hello ML Engineers! 👋 If you're preparing for Machine Learning System Design interviews at FAANG, OpenAI, Anthropic, or any top tech company, you know how challenging it can be given the vast landscape of ML, Deep Learning, LLMs, and GenAI systems.
...
- [🎓 Best ML System Design Courses](#-best-ml-system-design-courses)
- [📖 Essential Books](#-essential-books)
- [🏢 Learning Platforms](#-learning-platforms)
- [💡 ML System Design Fundamentals](#-ml-system-design-fundamentals)
- [🧠 LLM & GenAI System Design](#-llm--genai-system-design)
- [🔍 Common Interview Questions](#-common-interview-questions)
- [🏗️ System Design Patterns](#️-system-design-patterns)
- [🚀 MLOps & Infrastructure](#-mlops--infrastructure)
- [📊 Real-World Case Studies](#-real-world-case-studies)
- [🎯 Interview Problems by Company](#-interview-problems-by-company)
- [📝 Cheat Sheets & Templates](#-cheat-sheets--templates)
- [🔬 Key Research Papers](#-key-research-papers)
- [📰 Engineering Blogs](#-engineering-blogs)
- [🛠️ Preparation Strategy](#️-preparation-strategy)
...
|------|--------|------|-------|--------|
| [Machine Learning System Design Interview](https://www.amazon.com/dp/B0BYB7KGBJ) | Alex Xu | 2024 | FAANG Interviews | ⭐⭐⭐⭐⭐ |
| [ML Interviews Book](https://huyenchip.com/ml-interviews-book/) | Chip Huyen | 2023 | Comprehensive Prep | ⭐⭐⭐⭐⭐ |
| [Ace the Data Science Interview](https://www.amazon.com/dp/0578973839) | Nick Singh | 2022 | DS + ML | ⭐⭐⭐⭐ |

### 📚 Foundational Knowledge
| Book | Author | Year | Focus | Rating |
|------|--------|------|-------|--------|
| [Designing Machine Learning Systems](https://www.amazon.com/dp/1098107969) | Chip Huyen | 2022 | Production ML | ⭐⭐⭐⭐⭐ |
| [Machine Learning System Design](https://www.manning.com/books/machine-learning-system-design) | Babushkin & Kravchenko | 2024 | End-to-End Examples | ⭐⭐⭐⭐ |
| [Designing Data-Intensive Applications](https://www.amazon.com/dp/1449373321) | Martin Kleppmann | 2017 | Distributed Systems | ⭐⭐⭐⭐⭐ |
...
#### 🏗️ RAG (Retrieval Augmented Generation) Systems
```
1. Simple RAG
   ├── Document Loading
   ├── Chunking & Embedding
...
2. Advanced RAG Patterns
   ...
   ├── Corrective RAG (self-grading + web fallback)
...
2. **Canary Deployment**: 5% → 20% → 50% → 100% traffic
...
```
Classification:
├── Imbalanced → XGBoost, SMOTE, Class weights
├── High-dimensional → SVM, Random Forest
├── Neural → CNN (images), RNN (sequences), Transformer (text)
└── Interpretable → Logistic Regression, Decision Trees
...
└── Neural → BERT for ranking, Deep relevance matching

Recommendation:
├── Collaborative → Matrix Factorization, Neural CF
├── Content-based → TF-IDF, Word2Vec, BERT
└── Hybrid → Wide & Deep, Two-tower models
```
...
├── Knowledge Distillation: 5-10x speedup
└── Model Selection: Smaller architectures

Serving Optimization:
├── Batching: Increased throughput
├── Caching: Sub-ms for repeated queries
├── GPU inference: 10-100x speedup for large models
└── Edge deployment: Eliminate network latency
...
- ❌ Forgetting about monitoring and maintenance
...
*If this repository helped you land your dream job, please consider [buying me a coffee](https://www.buymeacoffee.com/mlsystemdesign) ☕*
